...
at [nextcloud_behind_NGINX_proxy](https://github.com/jameskimmel/Nextcloud_Ubuntu/blob/main/nextcloud_behind_NGINX_proxy.md)
...
- assumes docker
- enables addition of other containers, particularly OnlyOffice
- seems to require Apache2 within the container
- seems to make it difficult to proxy behind nginx

[official nextcloud all in one](https://github.com/nextcloud/all-in-one)
[wiki on innumerable issues](https://github.com/nextcloud/all-in-one/discussions/categories/wiki)
